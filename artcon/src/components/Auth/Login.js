  ...
  return (
    <div className="min-h-screen flex items-center justify-center signup-background">
      ...
      <div className="absolute -top-2 -left-2 -right-2 -bottom-2 rounded-lg bg-gradient-to-r from-white via-white to-orange-600 shadow-lg animate-pulse" />
        <div
          id="form-container"
          className="bg-white p-8 rounded-lg shadow-2xl w-full md:w-80 sm:w-60 relative z-10 transform transition duration-500 ease-in-out flex flex-col items-center justify-center"
        >
          <h2
            id="form-title"
          ...
          <div className="flex items-center mt-2">
            ...
            <Link to="/register" className="flex items-center bg-orange-500 text-white gap-1 ml-2 px-4 py-2 cursor-pointer rounded-md hover:bg-blue-400 duration-300 hover:translate-x-2">
              Register
            </Link>
          </div>
        </div>
